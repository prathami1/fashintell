    ...
    return (
        <>          
            <div class="max-w-[400px] max-h-[1400px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">How is this vibe?</h5>
                    </a>
                    {/* <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">React with the side buttons below</p> */}

                    <button type="button" class="text-white bg-blue-100 hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
